...
function Home() {
  ...
  const [pageRated, setPageRated] = useState(false);
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'white' }}>
      ...
      {/* Page Rating Section */}
     <section style={{ padding: '2rem 0', background: '#f8f9fa', borderTop: '1px solid #eee' }}>
  <Container>
    {console.log('Rendering Page Rating Section', { pageRating, pageRated })}
    <h5 className="text-center mb-3" style={{ color: "#ffb300" }}>Rate this page</h5>
    <div className="d-flex justify-content-center align-items-center mb-2">
      {[1,2,3,4,5].map(num => (
        <Star
          ...
          size={32}
          style={{
            cursor: pageRated ? "default" : "pointer",
            color: pageRating >= num ? "#ffc107" : "#ccc",
            transition: "color 0.2s"
          }}
          fill={pageRating >= num ? "#ffc107" : "none"}
          onClick={() => {
            if (!pageRated) {
              setPageRating(num);
              setPageRated(true);
