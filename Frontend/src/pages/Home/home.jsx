...
//                 <Card.Body>
//                   <Card.Title className="mb-2" style={{ color: '#212529', fontWeight: 'bold' }}>
//                     15% Off Concert Tickets!
//                   </Card.Title>
//                 </Card.Body>
//               </Card>
//             </Col>
...
//           </Row>
//           <Row>
//             {/* كروت الايفنتس العادية بنفس شكل EventCard */}
//             <Col md={4} className="mb-4">
//               <EventCard
